...
(declaim (ftype (function (list-of-handlers string) (or null (function (alive/deps:dependencies alive/session/state:state cons) (or null hash-table)))) new-get-handler))
