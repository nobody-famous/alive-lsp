...
(defun xyz-tokens-for-string (str)
    (with-input-from-string (s str)
        (tokens:xyz-from-stream s)))


(defun test-foo ()
    (clue:test "Foo symbol"
        (clue:check-equal :expected (list (token:xyz-create
                                              ...
                                              :end-offset 3
                                              :text "foo"))
                          :actual (xyz-tokens-for-string "foo"))))
...
(defun test-defun ()
    (clue:test "Defun symbol"
        (clue:check-equal :expected (list (token:xyz-create
                                              ...
                                              :end-offset 5
                                              :text "defun"))
                          :actual (xyz-tokens-for-string "defun"))))
...
(defun test-comment ()
    (clue:test "Comment"
        (clue:check-equal :expected (list (token:xyz-create
                                              ...
                                              :end-offset 9
                                              :text "; Comment"))
                          :actual (xyz-tokens-for-string "; Comment"))))
    ...
    (clue:suite "String"
        (clue:test "String"
            (clue:check-equal :expected (list (token:xyz-create
                                                  ...
                                                  :end-offset 8
                                                  :text "\"String\""))
                              :actual (xyz-tokens-for-string "\"String\"")))
    ...
    (clue:test "Basic macro"
        (clue:check-equal :expected (list (token:xyz-create
                                          ...
                                          (token:xyz-create
                                              ...
                                              :end-offset 6
                                              :text "abcd"))
                          :actual (xyz-tokens-for-string "#'abcd"))))
    ...
    (clue:suite "ifdef"
        (clue:test "Ifdef macro"
            (clue:check-equal :expected (list (token:xyz-create
                                                  ...
                                                  :end-offset 3
                                                  :text "#+n"))
                              :actual (xyz-tokens-for-string "#+n")))
        ...
        (clue:test "Valid ifdef macro"
            (clue:check-equal :expected (list (token:xyz-create
                                                  ...
                                                  :end-offset 10
                                                  :text "#+(or a b)"))
                              :actual (xyz-tokens-for-string "#+(or a b)")))))
    ...
    (clue:test "Symbol with package"
        (clue:check-equal :expected (list (token:xyz-create
                                          ...
                                          (token:xyz-create
                                              ...
                                              :end-offset 8
                                              :text "bar"))
                          :actual (xyz-tokens-for-string "foo::bar"))))
...
(defun test-vertical-bars ()
    ...
    (clue:test "Unterminated vertical bar name"
        (clue:check-equal :expected (list (token:xyz-create
                                              ...
                                              :end-offset 7
                                              :text "|foo:ba"))
                          :actual (xyz-tokens-for-string "|foo:ba"))))
