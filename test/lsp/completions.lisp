...
(defun test-symbols-m ()
    (clue:test "Test symbols:m"
        (clue:check-equal :expected (list (comps:create-item :label "macro-p"
                                                             :kind 3
...
(defun test-defmacro ()
    (clue:test "Test defmacro"
        (clue:check-equal :expected (list (comps:create-item :label "defmacro"
                                                             :kind 3
...
(defun test-symbols ()
    (clue:test "Test symbols"
        (clue:check-equal :expected (list (comps:create-item :label "external-p"
                                                             :kind 3
...
(defun test-debug-io ()
    (clue:test "Test debug-io"
        (clue:check-equal :expected (list (comps:create-item :label "*invoke-debugger-hook*"
                                                             :kind 1
